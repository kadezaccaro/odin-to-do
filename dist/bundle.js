...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   AddTask: () => (/* binding */ AddTask)\n/* harmony export */ });\n/* harmony import */ var _DisplayList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DisplayList */ \"./src/components/DisplayList.js\");\n\r\n\r\nclass Task {\r\n  static currentId = 1;\r\n\r\n  constructor(title) {\r\n    this.title = title;\r\n    this.id = Task.currentId++;\r\n  }\r\n}\r\n\r\nconst AddTask = () => {\r\n  const list = [];\r\n\r\n  const btn = document.querySelector(\".add-btn\");\r\n  btn.addEventListener(\"click\", () => {\r\n    addToList(new Task(`Task ${Task.currentId}`));\r\n  });\r\n\r\n  function addToList(task) {\r\n    list.push(task);\r\n    (0,_DisplayList__WEBPACK_IMPORTED_MODULE_0__.DisplayList)(list);\r\n  }\r\n};\r\n\n\n//# sourceURL=webpack://odin-to-do/./src/components/AddTask.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   DisplayList: () => (/* binding */ DisplayList)\n/* harmony export */ });\n/* harmony import */ var _DeleteTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DeleteTask */ \"./src/components/DeleteTask.js\");\n\r\n\r\nconst DisplayList = (list) => {\r\n  const taskList = document.querySelector(\".task-list\");\r\n  taskList.innerHTML = \"\"; // Clear before rendering to prevent duplicates\r\n\r\n  list.forEach((task) => {\r\n    const listItem = document.createElement(\"li\");\r\n    listItem.innerHTML = `\r\n      <div class=\"input-container\">\r\n        <input type=\"checkbox\" />\r\n        <input type=\"text\" placeholder=\"${task.title}\" />\r\n      </div>\r\n      <div class=\"extra\">\r\n        <!-- <span class=\"due-date\">July 20, 2023 @ 12:00 AM</span> -->\r\n        <i class=\"fa-regular fa-calendar-days\"></i>\r\n        <i class=\"fa-regular fa-trash-can\"></i>\r\n      </div>\r\n    `;\r\n    listItem.setAttribute(\"data-id\", task.id);\r\n    taskList.appendChild(listItem);\r\n  });\r\n\r\n  (0,_DeleteTask__WEBPACK_IMPORTED_MODULE_0__.DeleteTask)(list);\r\n};\r\n\n\n//# sourceURL=webpack://odin-to-do/./src/components/DisplayList.js?");
